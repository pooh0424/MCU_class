...
volatile uint8_t old_xs, old_ys, new_xs, new_ys,old_xm, old_ym, new_xm, new_ym;
...
void RTC_IRQHandler(void)
{
    ...
    new_xs = 64 + (20-2) * sin(theta * 3.1415926/180);
    new_ys = 32 - (20-2) * cos(theta * 3.1415926/180);
	
    draw_Line(old_xs,old_ys,64,32,0x0000, 0x0000);
    draw_Line(new_xs,new_ys,64,32,0xFFFF, 0x0000);
    ...
    old_ys = new_ys;	
		...
		if(minute%10==0){
			theta = minute *6;
			new_xm = 64 + (20-6) * sin(theta * 3.1415926/180);
			new_ym = 32 - (20-6) * cos(theta * 3.1415926/180);
		
			draw_Line(old_xm,old_ym,64,32,0x0000, 0x0000);
			draw_Line(new_xm,new_ym,64,32,0xFFFF, 0x0000);
			old_xm = new_xm;
			old_ym = new_ym;	
		}
		else{
			draw_Line(old_xm,old_ym,64,32,0xFFFF, 0x0000);
		}
...
void Init_RTC(void)
{
  S_RTC_TIME_DATA_T sInitTime;
    ...
    sInitTime.u32DayOfWeek  = 0x0UL;
    sInitTime.u32TimeScale  = 1;
...
int32_t main(void)
{
    ...
    draw_Bmp64x64(32, 0, 0xFFFF, 0x0000, bmp_Clock);
	
    old_xs = 64 + (20-2) * sin(59*6 * 3.1415926/180);
    old_ys = 32 - (20-2) * cos(59*6 * 3.1415926/180);
    old_xm = 64 + (20-6) * sin(59*6 * 3.1415926/180);
    old_ym = 32 - (20-6) * cos(59*6 * 3.1415926/180);
