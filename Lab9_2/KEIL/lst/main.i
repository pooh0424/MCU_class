...
void Init_KEYandADC(void)
{
    ...
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), (0x00000001 | 0x00000002| 0x00000004), 0x3UL);
		(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((3)<<2))))=0; (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((4)<<2))))=0; (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((5)<<2))))=0;
...
int main(void)
{
	...
	while(1) {
		if(run){
			...
			if(count==20){		
					if(flag ==1){
						int value = ((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR[(0)] & (0xFFFFul << 0));
						uint16_t fgColor, bgColor;
						bgColor = 0x0000;
						fgColor = 0x0000;
