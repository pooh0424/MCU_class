...
void Init_KEYandADC(void)
{
    ...
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), (0x00000001 | 0x00000002| 0x00000004), 0x3UL);
		(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((3)<<2))))=1; (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((4)<<2))))=0; (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((5)<<2))))=1;
    GPIO_EnableInt(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), 0, 0x00000001UL);
    GPIO_EnableInt(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), 1, 0x00000001UL);
    GPIO_EnableInt(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), 2, 0x00000001UL);		
...
int32_t main (void)
{
  ...
  uint32_t pitch2[72] = {
	...
	uint32_t pitch1[48] = {
			500000, 500000, 500000, 500000, 500000, 500000, 1000000,1000000,  
			500000, 500000, 500000, 500000, 500000, 500000, 1000000,1000000,  
			500000, 500000, 500000, 500000, 500000, 500000, 1000000,1000000,  
			500000, 500000, 500000, 500000, 500000, 500000, 1000000,1000000,  
			500000, 500000, 500000, 500000, 500000, 500000, 1000000,1000000,  
    ...
    PWM_Start(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), (1UL));	
		...
		while(1){
			if(flag==1){
				...
				int value = ((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR[(7)] & (0xFFFFul << 0));
				if(value<200){
						volume = 0;
				}
				else if(value>3800){
			...
			if(song ==1){
				PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x0, music1[i], volume); 
				if (music1[i]!=0) PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), (1UL));
				...
				PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x0, music2[i], volume); 
				if (music2[i]!=0) PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), (1UL));
				else             PWM_DisableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), (1UL));
